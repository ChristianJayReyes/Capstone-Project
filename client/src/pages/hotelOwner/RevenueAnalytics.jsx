  ...
  const loadAnalyticsData = async () => {
    ...
    try {
      ...
      const [summaryRes, monthlyRes, roomTypesRes] = await Promise.all([
        fetch(`https://rrh-backend.vercel.app/api/dashboard/revenue-summary?${queryParams}`),
        fetch(`https://rrh-backend.vercel.app/api/dashboard/revenue-trends?${queryParams}`),
        fetch(`https://rrh-backend.vercel.app/api/dashboard/room-types`)
      ]);
