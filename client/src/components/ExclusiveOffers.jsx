...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30 bg-beige/10'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            ...
            <button className='group flex items-center gap-2 font-medium cursor-pointer max-md:mt-12' onClick={() => (window.location.href = '/offers')}>
                View All Offers
                <img src={assets.arrowIcon} alt="arrowIcon" className='group-hover:translate-x-1 tansition-all' />
            </button>
        </div>
