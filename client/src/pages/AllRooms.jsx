    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-20 md:pt-30 px-4 md:px-16 lg:px-24 xl:px-32'>
      <div>
        <div>
          ...
          <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take Advantage of our limited offers and special packages to enhance your stay and create unforgettable memories</p>
        </div>
        {roomsDummyData.map((room) => (
          <div className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-200 last:border-0' key={room._id}>
            <img onClick={() => {navigate(`/rooms/${room._id}`); scrollTo(0,0)}} src={room.images[0]} alt="hotel-img" title='View Room Details' className='max-h-65 md:w-1/2 rounded-xl shadow-large object-cover cursor-pointer'/>
