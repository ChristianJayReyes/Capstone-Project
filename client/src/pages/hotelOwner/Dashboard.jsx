...
const Dashboard = () => {
  ...
  return (
    ...
    {/* Recent Bookings */}
    <h2 className='text-xl text-blue-950/70 font-medium mb-5 mt-20 text-center'>Recent Bookings</h2>
          ...
          {dashboardData.bookings.map((item, index) => (
            <tr key={index}>
              ...
              <td className='py-3 px-4 border-t border-gray-300 flex justify-center'>
                <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? 'bg-green-100 text-green-600' : 'bg-amber-100 text-yellow-600'}`}>
